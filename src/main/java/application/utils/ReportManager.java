...
public class ReportManager {
      ...
      URL fontPath = getClass().getResource("/fonts/DejaVuSans.ttf");

      public ReportManager(DefaultTableModel _table, JFrame _parent, String _title, float[] _columnWidths,
            String[] _headersPdfExport) {
              table =_table;
              parent = _parent;
              title = _title;
              columnWidths = _columnWidths;
              headersPdfExport = _headersPdfExport;
      }
      ...
      public void printReport() throws Exception {
        ...
        String fileTitle = "_report.pdf";
        
        save.setFile(fileTitle);
